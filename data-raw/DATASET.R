...
## generate continuous outcome Y, binary mediator M, single measured covariate X====
...
continuousY_binaryM <- generate_data(500)$data
...
## generate continuous outcome Y, continuous mediator M, 10 dimension covariate X====
...
continuousY_continuousM_10dX <- generate_data(500)$data

## generate continuous outcome Y, bivariate continuous mediator M, single measured covariate X====
...
continuousY_bivariateM <- generate_data(500)$data

## generate continuous outcome Y, quadrivariate continuous mediator M, single measured covariate X====
...
continuousY_quadrivariateM <- generate_data(500)$data


## generate binary outcome Y, binary mediator M, single measured covariate X====
...
binaryY_binaryM <- generate_data(500)$data

## generate binary outcome Y, continuous mediator M, single measured covariate X====
...
binaryY_continuousM <- generate_data(500)$data

## generate binary outcome Y, bivariate continuous mediator M, single measured covariate X====
...
binaryY_bivariateM <- generate_data(500)$data
...
binaryY_quadrivariateM <- generate_data(500)$data

## generate continuous outcome Y, binary mediator M, single measured covariate X with the issue of WEAK OVERLAP====
...
continuousY_binaryM_weakoverlap <- generate_data(500)$data

## generate continuous outcome Y, continuous mediator M, single measured covariate X with the issue of WEAK OVERLAP====
...
continuousY_continuousM_weakoverlap <- generate_data(500)$data
...
continuousY_bivariateM_weakoverlap <- generate_data(500)$data


usethis::use_data(continuousY_binaryM,continuousY_continuousM,continuousY_bivariateM,continuousY_quadrivariateM,binaryY_binaryM,binaryY_continuousM,binaryY_bivariateM,binaryY_quadrivariateM,
                  continuousY_binaryM_weakoverlap,continuousY_continuousM_weakoverlap,continuousY_bivariateM_weakoverlap, continuousY_continuousM_10dX,overwrite = TRUE)
