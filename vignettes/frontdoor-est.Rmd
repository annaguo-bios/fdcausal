...
```{r example-regression, eval=FALSE}
...
### Estimate mediator density under different types of mediators
...
```{r example-output-bayes, eval=FALSE}
cYcM <- estfd(a=c(1,0), data=continuousY_continuousM_10dX,
             treatment="A", mediators="M", outcome="Y", covariates=paste0("X.",1:10), 
